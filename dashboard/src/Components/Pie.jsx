    ...
    datasets: [
      {
        data: pieData,
        borderWidth: 1,
        backgroundColor: ["#7C95EA", "#544B8D","#FFC400", "#3BB85E","#B54F69","#E994B1"],
        hoverOffset: 50,
      },
    ],
  });
    ...
    <div className="nut">
      <div className="doug">
        ...
        <div className="bigbig">
          <div className="flx">
            <div ><p></p><span>Adani</span><span></span></div>
            <div ><p></p><span>Reliance</span><span></span></div>
            <div ><p></p><span>Rezicure</span><span></span></div>
            <div ><p></p><span>Ruzzet</span><span></span></div>
          </div>
        </div>
      </div>
